...
class Ps2MouseCallbackRegistry
{
  ...
  public:
    ...
    {
      private:
        using UnregisterThunk = void (*)(
            void *, void *, Registration *);

      public:
        Registration()
            : m_pOwner(nullptr), m_pSlot(nullptr), m_Unregister(nullptr)
        {
        }
      ...
      private:
        ...
        void adopt(
            void *owner, void *slot, UnregisterThunk unregister)
        {
            m_pOwner = owner;
            m_pSlot = slot;
    ...
    MUST_USE_RESULT bool subscribe(
