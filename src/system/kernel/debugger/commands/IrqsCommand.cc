...
bool parseLineFilter(const HugeStaticString& input, bool& hasFilter, uint8_t& line) {
...
void IrqsCommand::autocomplete(const HugeStaticString& input, HugeStaticString& output) {}

bool IrqsCommand::execute(const HugeStaticString& input, HugeStaticString& output,
