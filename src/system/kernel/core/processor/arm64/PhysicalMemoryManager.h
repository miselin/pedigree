#ifndef KERNEL_PROCESSOR_ARM64_PHYSICALMEMORYMANAGER_H
#define KERNEL_PROCESSOR_ARM64_PHYSICALMEMORYMANAGER_H
...
class Arm64PhysicalMemoryManager final : public PhysicalMemoryManager {
 public:
  static Arm64PhysicalMemoryManager& instance();
