...
/* Keep the core usable by the freestanding kernel as well as libc-backed
 * userspace.  The library only needs a small, bounded formatter for its
 * protocol replies; depending on stdio here would pull hosted I/O into the
 * kernel module. */
