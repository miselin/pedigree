...
class PosixSyscallTranslationTests(unittest.TestCase):
    def test_owned_map_matches_pre_migration_musl_mapping(self):
        ...
        # route, the five epoll entry points, and both eventfd entry points.
        # This locks both sides of all 156 mappings.
        self.assertEqual(len(mapping), 156)
        self.assertEqual(
            hashlib.sha256(serialized.encode()).hexdigest(),
            "cbf158b64f73e18cc706aec2ba8c5cc60dd0c5c0e54cd2bcc68debe42815a98e",
        )
    ...
    def test_every_owned_number_translates_without_libc_headers(self):
        ...
        source = textwrap.dedent(
            ...
            #undef PEDIGREE_LINUX_AMD64_SYSCALL
              ...
              if (posix_translate_syscall(17) != -1) return 3;
              return 0;
            }
            """
        )
