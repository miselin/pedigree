#!/usr/bin/env python3
"""Run the compiler stage matrix in a disposable guest."""
...
def main():
    ...
    report = {"result": "FAIL", "os": args.os, "mode": args.mode, "cpus": args.cpus,
    ...
    try:
        ...
        command = [args.qemu, "-machine", "q35", "-accel", "tcg,thread=multi",
                   "-smp", str(args.cpus), "-m", "4096", "-cpu", "SandyBridge,-rdrand,-rdseed"]
        if args.os == "pedigree":
